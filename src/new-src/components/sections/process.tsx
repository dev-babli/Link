    ...
    >
      ...
      <div className="w-64 flex flex-col justify-between p-7 relative z-10">
        ...
        <div className="mt-auto space-y-2.5">
          ...
          <motion.p 
            className={`text-sm leading-[1.6] text-left font-body ${isHovered ? 'text-text-primary' : 'text-text-secondary'}`}
            animate={{ 
      ...
      <motion.div
        className="relative overflow-hidden flex-1 rounded-r-[24px]"
